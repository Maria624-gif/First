package Main;
//Задание №8
//Напишите программу для печати всех различных перестановок данной строки в отсортированном порядке.
// Обратите внимание, что входная строка может содержать повторяющиеся символы
import java.io.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Варианты перестановки введенной строки: ");
